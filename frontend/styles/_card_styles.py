...
from frontend.ui_tokens import RADIUS_LG, RADIUS_MD, SPACE_XXXS


_CARD_BASE = f"QFrame {{    background: {_BG_RAISED};    border: {SPACE_XXXS}px solid {_BORDER_DIM};    border-radius: {RADIUS_LG}px;}}"

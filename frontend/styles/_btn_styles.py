...
_PRIMARY_BTN = (
    ...
    f"        stop:0 {_ACCENT_GRAD_START}, stop:1 {_ACCENT_GRAD_END});"
    ...
    "QPushButton:hover {"
    "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0,"
    f"        stop:0 {_ACCENT_GRAD_HOVER_START}, stop:1 {_ACCENT_GRAD_HOVER_END});"
    "}"
    "QPushButton:focus {"
    ...
    "QPushButton:pressed {"
    "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0,"
    f"        stop:0 {_ACCENT_GRAD_PRESSED_START}, stop:1 {_ACCENT_GRAD_PRESSED_END});"
    "}"
...
_DANGER_BTN = (
    ...
    f"    border-radius: {RADIUS_LG}px;"
    "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0,"
    f"        stop:0 {_DANGER_GRAD_START}, stop:1 {_DANGER_GRAD_END});"
    f"    color: {_TEXT_ON_ACCENT};"
    f"    font-weight: {FONT_WEIGHT_BOLD};"
    f"    font-size: {FONT_SIZE_BODY}px;"
    f"    padding: 0 {SPACE_MD}px;"
    ...
    "QPushButton:hover {"
    "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0,"
    f"        stop:0 {_DANGER_GRAD_HOVER_START}, stop:1 {_DANGER_GRAD_HOVER_END});"
    "}"
    "QPushButton:focus {"
    ...
    "QPushButton:pressed {"
    "    background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0,"
    f"        stop:0 {_DANGER_GRAD_PRESSED_START}, stop:1 {_DANGER_GRAD_PRESSED_END});"
    "}"
    "QPushButton:disabled {"
    f"    background: {_BORDER_DIM};"
    f"    color: {_TEXT_MUTED};"
